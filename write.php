...
/*    echo "image: " . $new_filename . "<br>";
    ...
    $sql = "INSERT INTO `book_page_table`(`book_id`, `image_filename`, `storyteller`, `input_date`, `input_comment`, `storybook_name`, `child_name`, `progress`, `child_feedback`) VALUES " .
                                        "(:book_id , :image_filename , :storyteller , sysdate()   , :input_comment , :storybook_name , :child_name , :progress , :child_feedback)";
    $stmt = $pdo->prepare($sql);
